...
install:
	...
	install -m 0644 lib/proc.py ${PREFIX}/lib/0xtools/proc.py
	install -m 0644 lib/psnreport.py ${PREFIX}/lib/0xtools/psnreport.py
	install -m 0644 lib/argparse.py ${PREFIX}/lib/0xtools/argparse.py
